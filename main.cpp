...
uint32_t DmaTimMode = (DMA_PRIORITY_VERYHIGH | DMA_MSIZE_16_BIT
        | DMA_PSIZE_16_BIT | DMA_MEM_INC | DMA_DIR_MEM2PER | DMA_CIRC);
...
//    Clk
    if(Clk::EnableHSE() == retvOk) {
        Clk::SetupPll(Clk::pllmul12, Clk::pllSrcPrediv, Clk::prediv1,
                Clk::prediv1srcHSE);
    ...
    Gpio::SetupOut(GPIOA, 11, Gpio::outmodePushPull);
